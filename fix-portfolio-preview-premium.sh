...
echo "=============================================="
echo " FIX PORTFOLIO PREVIEW PREMIUM"
echo " Landing Source Correct"
echo "=============================================="
...
mkdir -p backup/portfolio-preview-$STAMP

cp src/pages/Landing/components/PortfolioPreview.tsx \
backup/portfolio-preview-$STAMP/


echo "[2/6] Update PortfolioPreview..."


cat <<'PORTFOLIO' > src/pages/Landing/components/PortfolioPreview.tsx
...
git add src/pages/Landing/components/PortfolioPreview.tsx

git commit -m "Fix Landing Portfolio Preview component" || true
...
echo "=============================================="
echo " PORTFOLIO PREVIEW FIX COMPLETE"
echo " Backup:"
echo " backup/portfolio-preview-$STAMP"
echo "=============================================="
