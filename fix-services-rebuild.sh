...
echo "=============================================="
echo " StudioIT FIX SERVICES REBUILD"
echo " Repair JSX Structure"
echo "=============================================="


STAMP=$(date +"%Y%m%d_%H%M%S")

mkdir -p backup/services-rebuild-$STAMP


cp src/pages/Services/index.tsx \
backup/services-rebuild-$STAMP/ 2>/dev/null || true
...
git commit -m "Fix Services JSX structure and hero layout" || true
...
echo "=============================================="
echo " SERVICES FIX COMPLETE"
echo " Backup:"
echo " backup/services-rebuild-$STAMP"
echo "=============================================="
