...
echo "=============================================="
echo " StudioIT HERO CONTENT UPDATE"
echo " Software House Identity"
echo "=============================================="
...
mkdir -p backup/hero-detail-$STAMP

cp src/pages/Landing/components/Hero.tsx \
backup/hero-detail-$STAMP/Hero.tsx


echo "[2/5] Update Hero..."
...
git commit -m "Update StudioIT Hero professional identity" || true
...
echo "=============================================="
echo " HERO UPDATE COMPLETE"
echo " Backup:"
echo " backup/hero-detail-$STAMP"
echo "=============================================="
